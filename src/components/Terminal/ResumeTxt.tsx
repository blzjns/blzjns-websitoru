...
export default function ResumeTxt() {
  return (
    <div className="flex flex-col">
      <span>{TERMINAL_WELCOME_MSG}</span>
      <span className="mt-5">
...
▄██ █ █ █ █▄▄ █▄▄ ▄██       █▄▀ █▄▄ ▀▄▀ ▄   ▄██  █  █▀█ ▀▄▄ █ █
                  `}</span>
      <span className="">
        <b>[Coding languages]:</b> JavaScript/TypeScript, Java/Scala, Golang,
        .Net (C#, VB), Bash, SQL, and Python.
      </span>
      <span className="">
        <b>[Technologies]:</b> Git, Node.js/Next.js, Graphql, React/Angular,
        jQuery, Jest/Mocha/Jasmine/Karma, HTML, CSS/Sass/Less, Bootstrap,
        Spring, Maven, Gradle, MySQL/HANA/SQLServer, MongoDB, Kubernetes,
        Docker, Cloud Foundry, Codepipeline/Travis/Jenkins, AWS/Azure/GCP - also
        interested in: WebAssembly, WebGL, Rust, Flutter, Computer Vision
        [OpenCV, dLib], and Machine Learning [TensorFlow].
      </span>
      <span>{`
█▀▄ █▀▄ ▄▀▄ █▀ ██▀ ▄▀▀ ▄▀▀ █ ▄▀▄ █▄ █ ▄▀▄ █     ██▀ ▀▄▀ █▀▄ ██▀ █▀▄ █ ██▀ █▄ █ ▄▀▀ ██▀
█▀  █▀▄ ▀▄▀ █▀ █▄▄ ▄██ ▄██ █ ▀▄▀ █ ▀█ █▀█ █▄▄   █▄▄ █ █ █▀  █▄▄ █▀▄ █ █▄▄ █ ▀█ ▀▄▄ █▄▄
        ...
        <div id="sapXP" className="flex flex-col pb-5">
          ...
          <span className="">
            ...
            <ul className="list-[square] ml-5">
              ...
              <li>
                Went to SAP Labs in Gliwice to meet the Kyma R&amp;D team and
                help defining the support process for customers adopting newer
                cloud solutions
              </li>
              <li>
